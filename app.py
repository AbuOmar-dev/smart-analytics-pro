...
if st.session_state.page == "home":
    ...
    if st.session_state.df is None: st.warning("️ يرجى رفع البيانات أولاً")
        ...
        outlier_option = st.selectbox("3️ معالجة القيم المتطرفة", ["لا تفعل شيئاً", "حذف القيم المتطرفة (طريقة IQR)"], key="outlier_option")
                    ...
                    * {{ box-sizing: border-box; }}
                    ...
                    if skipped_cols:
                        ...
                        <div class="insight-box">
                            ℹ️ <strong>ملاحظة:</strong> تم استبعاد الأعمدة التالية تلقائياً لأنها تعتبر معرفات فريدة أو تواريخ:
                    ...
                    st.success("✅ تم إنشاء التقرير بنجاح! افتحه في المتصفح. للطباعة كـ PDF: Ctrl+P → Save as PDF")
                except Exception as e:
